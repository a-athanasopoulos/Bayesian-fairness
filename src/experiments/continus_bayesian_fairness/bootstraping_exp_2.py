...
from src.experiments.continus_bayesian_fairness.loop_2 import run_bootstrap_algorithm_loop_2, \
    run_marginal_algorithm_loop_2
...
def run_continuous_compass_experiment(data_path, save_path):
    ...
    l_list = [0.0, 0.25, 0.5, 0.75, 1.0]  # lambda
    dirichlet_prior = 0.5
    ...
    for tmp_l in l_list:
        ...
        bootstrap_cont_results = run_bootstrap_algorithm_loop_2(train_data=train_data,
        ...
        marginal_cont_results = run_marginal_algorithm_loop_2(train_data=train_data,
                                                              test_data_and_models=test_data_and_models,
                                                              Z_atr=Z_atr,
                                                              X_atr=X_atr,
                                                              Y_atr=Y_atr,
...
if __name__ == "__main__":
    # ******************PATH Configuration****************
    exp_name = "exp_compas_boostrap_continuous_2"
    exp_number = "org_loss"  # add experiment sub-name
